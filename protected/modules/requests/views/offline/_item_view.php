...
<tr data-max="<?= $data->getMaxID() ?>">
    ...
    <td class="text-center"><?= CHtml::link('بررسی درخواست', Yii::app()->createUrl('/requests/offline/view/'.$data->id.'?pending'),[
            'class' => 'btn btn-xs btn-info'
        ]) ?></td>
    <td class="text-center"><?= CHtml::link('حذف درخواست', Yii::app()->createUrl('/requests/offline/delete/'.$data->id.'/?pending'),[
